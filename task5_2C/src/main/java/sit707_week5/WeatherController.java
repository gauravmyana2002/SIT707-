...
public class WeatherController {
	...
	private DateProvider dateProvider = new SystemDateProvider();
	...
	private static class SystemDateProvider implements DateProvider {
		public Date now() {
			return new Date();
		}
	}
	...
	public String persistTemperature(int hour, double temperature) {
		...
		String savedTime = sdf.format(dateProvider.now());
